...
from GOKUMUSIC.plugins.modules.pretenderdb import impo_off, impo_on, check_pretender, add_userdata, get_userdata, usr_data
from GOKUMUSIC import app

BULMA = [
    "https://telegra.ph/file/aa1dc59f0963290f4fd4a.jpg"
]
...
VEGITA = [
    [
        InlineKeyboardButton(
            text="ᴀᴅᴅ ᴍᴇ",
            url=f"https://t.me/Fancy_Waifu_Husbando_Bot?startgroup=true"),
        InlineKeyboardButton(text="ᴜᴘᴅᴀᴛᴇ", url=f"https://t.me/Blade_x_community")
    ],
]
