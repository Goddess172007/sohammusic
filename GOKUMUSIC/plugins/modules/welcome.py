...
random_photo = [
    ...
    "https://telegra.ph/file/e786610a967f76883f5c7.jpg",
    "https://telegra.ph/file/2a2adf52e3dfb9dc25b7c.jpg",
    "https://telegra.ph/file/0708dc3ab998b72250409.jpg",
    "https://telegra.ph/file/c8d78e2a39119d2262adc.jpg",
]
# --------------------------------------------------------------------------------- #
...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    background = Image.open("GOKUMUSIC/assets/wel2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp, brightness_factor=brightness_factor) 
    pfp = pfp.resize((330, 330))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('GOKUMUSIC/assets/font.ttf', size=70)
    welcome_font = ImageFont.truetype('GOKUMUSIC/assets/font.ttf', size=61)
 
    pfp_position = (264, 257)
