...
from GOKUMUSIC.mongo.nightmodedb import nightdb,nightmode_on,nightmode_off,get_nightchats 
...
async def _nightmode(_, message):
    return await message.reply_photo(photo="https://telegra.ph/file/674cf5315de86ffda4761.jpg", caption="**ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ᴛᴏ ᴇɴᴀʙʟᴇ ᴏʀ ᴅɪsᴀʙʟᴇ ɴɪɢʜᴛᴍᴏᴅᴇ ɪɴ ᴛʜɪs ᴄʜᴀᴛ.**",reply_markup=buttons)
    ...
    for add_chat in chats:
        try:
            await app.send_photo(
                add_chat,
                photo="https://telegra.ph/file/6ef975cbe87bb8362ea70.jpg",
...
async def close_nightmode():
    ...
    for rm_chat in chats:
        try:
            await app.send_photo(
                rm_chat,
                photo="https://telegra.ph/file/6cd3685f56ad503544a1e.jpg",
